...
(function (W) {
    ...
    !function () {
        ...
        W._colModel = [
            ...
            {name: 'sample_date', width: 130, index: 'sample_date', align: 'center', sortable: true},
            {name: 'receive_date', width: 130, index: 'receive_date', align: 'center', sortable: true},
            {name: 'real_name', width: 100, index: 'real_name', align: 'center', sortable: true},
            {name: 'id_card', width: 100, index: 'id_card', align: 'center', sortable: true},
            {name: 'age', width: 130, index: 'age', align: 'center', sortable: true},
            {
                name: 'pregnancy_week', width: 100, index: 'pregnancy_week', align: 'center', sortable: true, formatter: function (value, options, row) {
                return value;
            }
            },
            ...
            {name: 'input_date', width: 130, index: 'input_date', align: 'center', sortable: true},
            {name: 'checker', width: 100, index: 'checker', align: 'center', sortable: true},
            {name: 'check_date', width: 130, index: 'check_date', align: 'center', sortable: true},
